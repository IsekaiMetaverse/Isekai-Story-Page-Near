    ...
    .send({
     ...
     //  value: totalCostWei,
      ...
      .then((receipt) => {
        console.log(receipt);
        setFeedback(
          `WOW, the ${CONFIG.NFT_NAME} is yours! go visit mintbase.io to view it.`
        );
        setClaimingNft(false);
  ...
  return (
    <s.Screen>
      ...
      >
        ...
        <s.Container1>        
        <s.TextTitleButton >
         <a  href="https://testnet.mintbase.io/" class="link_button">Mintbase</a>
        </s.TextTitleButton>
        <s.SpacerSmall/>  
        <s.TextTitleButton>
        ...
        <s.TextTitleButton>
         ...
         <s.SpacerSmall/>
        <s.TextTitleButton>
         <a href="https://testnet.aurorascan.dev/address/0x100577275a9DCa175bC780e41dA6604F6D61dbe4" class="link_button" >Contract</a>
         </s.TextTitleButton> 
        </s.Container1> 
